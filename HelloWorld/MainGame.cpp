...
bool MainGameUpdate( float elapsedTime ) {
    ...
    UpdateLasers();
    UpdateDestroyed();
    Play::DrawFontText("64px", "ARROW KEYS UP and DOWN (OR W and S) TO MOVE UP AND DOWN AND SPACE TO FIRE",
...
void HandlePlayerControls() {
    ...
    if (Play::KeyDown(VK_UP) || Play::KeyDown(0x57)) {
        obj_agent8.velocity = { 0, -4 };
        Play::SetSprite(obj_agent8, "agent8_climb", 0.25f);
    } else if (Play::KeyDown(VK_DOWN) || Play::KeyDown(0x53)) {
